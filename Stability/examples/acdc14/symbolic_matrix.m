...
A_sub = subs(A, [K_ipll1, K_ppll1, K_ipll2, K_ppll2, K_ipll3, K_ppll3, K_ipll4, K_ppll4, K_ipll5, K_ppll5, k_1, k_2, k_3, k_4, k_5], [K_ipll1_val, K_ppll1_val, K_ipll2_val, K_ppll2_val, K_ipll3_val, K_ppll3_val, K_ipll4_val, K_ppll4_val, K_ipll5_val, K_ppll5_val, k_1_val, k_2_val, k_3_val, k_4_val, k_5_val]);
...
ki_PLL_vec  = sym(NaN(5,1));
kp_PLL_vec  = sym(NaN(5,1));
k_droop_vec = sym(NaN(5,1));

ki_PLL_val  = sym(NaN(5,1));
kp_PLL_val  = sym(NaN(5,1));
k_droop_val = sym(NaN(5,1));
