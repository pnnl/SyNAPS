'''
This function is taken from Pypower with some modification: "https://github.com/rwl/PYPOWER/blob/master/pypower/makeYbus.py".
...
#     tap[i] = branch[i, TAP]                  ## assign non-zero tap ratios
    i = np.atleast_1d(0).nonzero()             ## indices of non-zero tap ratios
    tap[i] = 0                  ## assign non-zero tap ratios
#     tap = tap * exp(1j * pi / 180 * branch[:, SHIFT]) ## add phase shifters
    tap = tap * exp(1j * pi / 180 * 0) ## add phase shifters
